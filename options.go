...
// Panics if buckets is empty. Invalid bucket values (not strictly
// increasing, contain NaN, or contain +Inf) cause a panic at
// NewCollector time when Prometheus validates the histogram.
